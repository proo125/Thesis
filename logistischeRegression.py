...
# 4. Logistische Regressionsmodell
# Modell trainieren
log_reg = LogisticRegression()
log_reg.fit(X_train_skaliert, y_train)
...
plt.title('Konfusionsmatrix (Standard LR)')
plt.xlabel('Vorhergesagt')
plt.ylabel('Tatsächlich')
plt.show()

# Klassifikationsbericht
print("\nKlassifikationsbericht(Standard LR):")
...
plt.title('Receiver Operating Characteristic (ROC) Kurve (Standard-LR)')
plt.legend()
plt.show()